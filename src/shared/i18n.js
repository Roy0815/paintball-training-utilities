...
const STRINGS = {
  'shell.appTitle': {
    de: 'Paintball Training Utilities',
    en: 'Paintball Training Utilities',
  },
  ...
  'feature.snaptrainingDryrun.name': {
    de: 'Snaptraining Dryrun',
    en: 'Snaptraining Dryrun',
  },
  ...
  'snap-dryrun.list.newPosition': {
    de: '+ Neue Snapshot-Position',
    en: '+ New snapshot position',
  },
  ...
  'snap-dryrun.list.trainedAt': {
    de: 'Bildmodell trainiert am {date}',
    en: 'Image model trained on {date}',
  },
  'snap-dryrun.list.notTrained': {
    de: 'Noch nicht trainiert',
    en: 'Not trained yet',
  },
  ...
  'snap-dryrun.setup.title': {
    de: 'Neue Snapshot-Position',
    en: 'New snapshot position',
  },
  'snap-dryrun.setup.nameLabel': {
  ...
  'snap-dryrun.setup.nameRequired': {
  ...
  'snap-dryrun.setup.next': {
    de: 'Weiter zur Aufnahme',
  ...
  'snap-dryrun.capture.title': {
    de: 'Trainingsdaten sammeln',
    en: 'Collect training data',
  },
  'snap-dryrun.capture.startCamera': {
    de: 'Kamera starten',
    en: 'Start camera',
  },
  'snap-dryrun.capture.countLabel': {
    de: 'Anzahl Fotos',
    en: 'Number of photos',
  },
  'snap-dryrun.capture.intervalLabel': {
    de: 'Intervall (ms)',
    en: 'Interval (ms)',
  },
  'snap-dryrun.capture.delayLabel': {
    de: 'Start-Verzögerung (s)',
    en: 'Start delay (s)',
  },
  'snap-dryrun.capture.start': { de: 'Serie aufnehmen', en: 'Capture series' },
  'snap-dryrun.capture.retake': {
    de: 'Serie erneut aufnehmen',
    en: 'Retake series',
  },
  'snap-dryrun.capture.stop': { de: 'Aufnahme stoppen', en: 'Stop capture' },
  'snap-dryrun.capture.countdown': {
    de: 'Start in {seconds}s…',
    en: 'Starting in {seconds}s…',
  },
  'snap-dryrun.capture.progress': {
    de: '{index}/{total} Fotos aufgenommen',
    en: '{index}/{total} photos taken',
  },
  'snap-dryrun.capture.cameraError': {
    de: 'Kamerazugriff fehlgeschlagen: {message}',
    en: 'Camera access failed: {message}',
  },
  'snap-dryrun.capture.next': {
    de: 'Weiter zum Labeling',
    en: 'Continue to labeling',
  },
  ...
  'snap-dryrun.label.photoCounter': {
    de: 'Foto {index} / {total}',
    en: 'Photo {index} / {total}',
  },
  'snap-dryrun.label.currentPrefix': { de: 'aktuell', en: 'current' },
  'snap-dryrun.label.summaryTitle': {
    de: 'Fotos gelabelt',
    en: 'Photos labeled',
  },
  ...
  'snap-dryrun.label.summaryMissing': {
    de: 'Noch zu wenig Beispiele: {list}',
    en: 'Not enough examples yet: {list}',
  },
  ...
  'snap-dryrun.train.runningProgress': {
    de: 'Training läuft… ({done}/{total})',
    en: 'Training… ({done}/{total})',
  },
  'snap-dryrun.train.done': {
    de: 'Fertig. Snapshot-Position "{name}" ist trainiert.',
    en: 'Done. Snapshot position "{name}" is trained.',
  },
  'snap-dryrun.train.error': {
    de: 'Training fehlgeschlagen: {message}',
    en: 'Training failed: {message}',
  },
  'snap-dryrun.train.doneBtn': {
    de: 'Zu den Snapshot-Positionen',
    en: 'Go to snapshot positions',
  },

  'snap-dryrun.live.reset': { de: 'Counter zurücksetzen', en: 'Reset counter' },
  'snap-dryrun.live.starting': {
    de: 'Kamera wird gestartet…',
    en: 'Starting camera…',
  },
  'snap-dryrun.live.status': {
    de: 'Snap: {snap}% · Deckung: {cover}%',
    en: 'Snap: {snap}% · Cover: {cover}%',
  },
  'snap-dryrun.live.stateSnap': { de: 'Snap!', en: 'Snap!' },
  'snap-dryrun.live.stateCover': { de: 'In Deckung', en: 'In cover' },
  'snap-dryrun.live.cameraError': {
    de: 'Live-Betrieb fehlgeschlagen: {message}',
    en: 'Live mode failed: {message}',
  },
  'snap-dryrun.live.delayLabel': {
    de: 'Start-Timer (s)',
    en: 'Start timer (s)',
  },
  'snap-dryrun.live.startTraining': {
    de: 'Training starten',
    en: 'Start training',
  },
  'snap-dryrun.live.stopTraining': {
    de: 'Training stoppen',
    en: 'Stop training',
  },
  'snap-dryrun.live.countdown': {
    de: 'Start in {seconds}s…',
    en: 'Starting in {seconds}s…',
  },
  ...
  'snap-dryrun.live.removePeek': {
    de: 'Letzten Wert entfernen',
    en: 'Remove last value',
  },

  'snap-dryrun.settings.cameraSound': {
    de: 'Kamera-Sound',
    en: 'Camera sound',
  },
  ...
  'snap-dryrun.settings.numberSound': {
    de: 'Zahlen-Sound',
    en: 'Number sound',
  },
